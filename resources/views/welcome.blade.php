...
<!-- Mirrored from preetheme.com/html/abfolio/abfolio/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2023 15:17:26 GMT -->
...
<head>
    ...
    <link rel="icon" href="{{ asset('contents/website') }}/assets/img/icon.png" type="image/gif"
        sizes="16x16" />
    <link rel="icon" href="{{ asset('contents/website') }}/assets/img/icon.png" type="image/gif"
        sizes="18x18" />
    <link rel="icon" href="{{ asset('contents/website') }}/assets/img/icon.png" type="image/gif"
    ...
    <link rel="stylesheet"
        href="{{ asset('contents/website') }}/assets/css/fontawesome.all.min.css" />
    <link rel="stylesheet" href="{{ asset('contents/website') }}/assets/css/owl.carousel.min.css" />
    <link rel="stylesheet"
        href="{{ asset('contents/website') }}/assets/css/owl.theme.default.min.css" />
    <link rel="stylesheet" href="{{ asset('contents/website') }}/assets/css/animate.css" />
    <link rel="stylesheet" href="{{ asset('contents/website') }}/assets/css/lightcase.css" />
    <link rel="stylesheet" href="{{ asset('contents/website') }}/assets/css/normalize.css" />
...
<body>
                    ...
                    <div class="logo">
                        <a href="index.html">
                            <img class="light-logo"
                                src="{{ asset('contents/website') }}/assets/img/logo.png"
                                alt="logo" />
                            <img class="drak-logo"
                                src="{{ asset('contents/website') }}/assets/img/white-logo.png"
                                alt="logo" />
                        </a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 align-self-end">
                    <div class="hero-image">
                        <img src="{{ asset('contents/website') }}/assets/img/hero.png" alt="img">
                        <!-- Image -->
                        <div class="hero-shap-img">
                            <img class="rotateme"
                                src="{{ asset('contents/website') }}/assets/img/ellipse-shape.png"
                                alt="img">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 mb-40">
                    <div class="about-img wow fadeInUp" data-wow-delay="0.3s">
                        <img src="{{ asset('contents/website') }}/assets/img/about.png" alt="img">
                    </div>
                </div>
                <!-- About Content -->
                <div class="col-lg-7 align-self-center mb-40">
                    <div class="about-content wow fadeInUp">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean consectetur ut lorem vitae
                            ultricies. Integer porta, libero sit amet pretium lobortis, tortor mauris eleifend urna, ut
                            laoreet velit nisi scelerisque ex. Fusce vel pulvinar ligula. Etiam eget dolor leo.
                            Phasellus eu dolor cursus, sodales nunc at, tempor turpis</p>
                        <a class="button-1" href="#">Download CV</a>
                        <div class="row">
                            <!-- row -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="services-box">
                        ...
                        <h2>Web Design</h2>
                        <p>In nisi tortor, consequat eu semper ut, consequat in massa. Maecenas at odio a felis commodo
                            pulvinar quis eu neque.</p>
                    </div>
                </div>
                <!-- Services Single -->
                <div class="col-lg-4 col-md-6 mb-30">
                ...
                <div class="row portfolio-full portF">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 mix design app">
                        <div class="portfolio-item">
                            <img src="{{ asset('contents/website') }}/assets/img/portfolio/1.jpg"
                                alt="portfolio">
                            <div class="portfolio-item-overly">
                                <div class="portfolio-item-overly-full">
                                    <a data-rel="lightcase:myCollection:portfolio"
                                        href="{{ asset('contents/website') }}/assets/img/portfolio/1.jpg"><i
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 mix development">
                        <div class="portfolio-item">
                            <img src="{{ asset('contents/website') }}/assets/img/portfolio/2.jpg"
                                alt="portfolio">
                            <div class="portfolio-item-overly">
                                <div class="portfolio-item-overly-full">
                                    <a data-rel="lightcase:myCollection:portfolio"
                                        href="{{ asset('contents/website') }}/assets/img/portfolio/2.jpg"><i
                                            class="fas fa-search-plus"></i></a>
                                    <a href="#">
                                        <i class="fas fa-eye"></i>
                                    </a>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 mix design development">
                        <div class="portfolio-item">
                            <img src="{{ asset('contents/website') }}/assets/img/portfolio/3.jpg"
                                alt="portfolio">
                            <div class="portfolio-item-overly">
                                <div class="portfolio-item-overly-full">
                                    <a data-rel="lightcase:myCollection:portfolio"
                                        href="{{ asset('contents/website') }}/assets/img/portfolio/3.jpg"><i
                                            class="fas fa-search-plus"></i></a>
                                    <a href="#">
                                        <i class="fas fa-eye"></i>
                                    </a>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 mix app">
                        <div class="portfolio-item">
                            <img src="{{ asset('contents/website') }}/assets/img/portfolio/4.jpg"
                                alt="portfolio">
                            <div class="portfolio-item-overly">
                                <div class="portfolio-item-overly-full">
                                    <a data-rel="lightcase:myCollection:portfolio"
                                        href="{{ asset('contents/website') }}/assets/img/portfolio/4.jpg"><i
                                            class="fas fa-search-plus"></i></a>
                                    <a href="#">
                                        <i class="fas fa-eye"></i>
                                    </a>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 mix design">
                        <div class="portfolio-item">
                            <img src="{{ asset('contents/website') }}/assets/img/portfolio/5.jpg"
                                alt="portfolio">
                            <div class="portfolio-item-overly">
                                <div class="portfolio-item-overly-full">
                                    <a data-rel="lightcase:myCollection:portfolio"
                                        href="{{ asset('contents/website') }}/assets/img/portfolio/5.jpg"><i
                                            class="fas fa-search-plus"></i></a>
                                    <a href="#">
                                        <i class="fas fa-eye"></i>
                                    </a>
                    ...
                    <div class="col-lg-4 col-md-6 mb-30 mix design app">
                        <div class="portfolio-item">
                            <img src="{{ asset('contents/website') }}/assets/img/portfolio/6.jpg"
                                alt="portfolio">
                            <div class="portfolio-item-overly">
                                <div class="portfolio-item-overly-full">
                                    <a data-rel="lightcase:myCollection:portfolio"
                                        href="{{ asset('contents/website') }}/assets/img/portfolio/6.jpg"><i
                                            class="fas fa-search-plus"></i></a>
                                    <a href="#">
                                        <i class="fas fa-eye"></i>
                                    </a>
            ...
            <div class="row">
                <div class="testimonial-full owl-carousel">
                    ...
                    <div class="testimonial-item">
                        <div class="thumbnail">
                            <img src="{{ asset('contents/website') }}/assets/img/tes1.jpg" alt="">
                        </div>
                        <div class="content">
                    ...
                    <div class="testimonial-item">
                        <div class="thumbnail">
                            <img src="{{ asset('contents/website') }}/assets/img/tes2.jpg" alt="">
                        </div>
                        <div class="content">
                            <p>Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor
                                incididunt ut labore.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="blog-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('contents/website') }}/assets/img/blog/1.jpg"
                                    alt="blog">
                            </a>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="blog-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('contents/website') }}/assets/img/blog/2.jpg"
                                    alt="blog">
                            </a>
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="blog-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="{{ asset('contents/website') }}/assets/img/blog/3.jpg"
                                    alt="blog">
                            </a>
                        </div>
                        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-30">
                    <div class="contact-form-info"
                        style="background-image:url('{{ asset('contents/website') }}/assets/img/contact.jpg');">
    ...
    <!-- Start Footer Area -->
    <footer class="footer"
        style="background-image: url('{{ asset('contents/website') }}/assets/img/footer.png');">
        <!-- Footer Top -->
    ...
    <!-- Js File -->
    <script src="{{ asset('contents/website') }}/assets/js/modernizr.min.js"></script>
    ...
    <script src="{{ asset('contents/website') }}/assets/js/jquery.nav.min.js"></script>
    <script src="{{ asset('contents/website') }}/assets/js/jquery.waypoints.min.js"></script>
    <script src="{{ asset('contents/website') }}/assets/js/jquery.counterup.min.js"></script>
    <script src="{{ asset('contents/website') }}/assets/js/lightcase.js"></script>
    <script src="{{ asset('contents/website') }}/assets/js/mixitup.min.js"></script>
